/* $Id: get_attachments.c,v 1.15 2017/01/18 07:33:09 stm Exp $
 *
...
*/
static int
process_document(FILE *outfp, const char * volatile filename,
        const char *realname, const unsigned char *data, int length)
{
    TET *tet;
