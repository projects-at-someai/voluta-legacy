...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar
{
    ...
    //Show password prompt
    [self ShowPasswordPopup:@"Laser Specialist:"
...
- (void)PerformSearch
{
    _SearchResults = [_FormDataManager FindForms:_SearchText];
...
- (void)SearchResultsComplete:(NSString *)txt withIndex:(NSUInteger)index {
    ...
    if (txt != nil && ![txt isEqualToString:@""] && index < [_SearchResults count]) {
        ...
        [_FormDataManager LoadFormFromClientInfo:[_SearchResults objectAtIndex:index]];
