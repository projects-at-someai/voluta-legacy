...
#define LOGO_PORTRAIT                       CGRectMake(161.0f, 660.0f, 450.0f, 253.0f)
...
#define LOGO_LANDSCAPE                      CGRectMake(525.0f, 55.0f, 450.0f, 300.0f)
...
@property (retain) LongTutorialViewController *LongTutorialVC;
@property (retain) IDCaptureViewController *IDCaptureVC;
@property (retain) InfoViewController *InfoVC;
