...
- (void)Help:(id)sender
{
    UIAlertController *helpAlert = [self.Alerts CreateOKAlert:^(UIAlertAction *action){} withTitle:@"Help" withMessage:@"PHOTO YOUR ID:\nWave your hand over the little cam at the top of the iPad. See that? CRAZY! Now hold your ID above that cam so it frames your ID nicely. Hit the TAKE PHOTO button with your other hand.\n\nLIGHT-SPEED FOR RETURN CLIENTS :\nSearch for you at the top of the screen by your first or last name. Your specialist will have to authorize the search to ensure client privacy. You can look over your old form and if it looks good, re-sign and you're done. If you need to change anything you can make a new form from scratch."];
