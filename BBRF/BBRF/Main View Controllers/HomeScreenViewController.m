...
- (void)viewDidAppear:(BOOL)animated {
    ...
    [_FormDataManager SetFormDataValue:[Utilities GetCurrentDateSimple] withKey:@"Date"];
    [_FormDataManager SetFormDataValue:@"No" withKey:@"International"];
    [_FormDataManager SetFormDataValue:[Utilities GetCountryName] withKey:@"Country"];
