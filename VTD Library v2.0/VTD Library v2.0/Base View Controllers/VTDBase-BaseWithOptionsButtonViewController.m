...
#import "VTDBase-BaseWithOptionsButtonViewController.h"

@interface VTDBase-BaseWithOptionsButtonViewController ()

@end

@implementation VTDBase-BaseWithOptionsButtonViewController
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar
{
    ...
    //Show password prompt
    [self ShowPasswordPopup:@"Microblade Specialist:"
