//
//  VTDBase-BaseWithOptionsButtonViewController.h
//
//
...
#import "VTDBase-VolutaBaseViewController.h"
...
@class VTDBase-BaseWithOptionsButtonViewController;

@protocol VTDBase-BaseOptionsDelegate <NSObject>

@required
- (void)OptionsTapped:(VTDBase-BaseWithOptionsButtonViewController *)VC withPasswordPromptTitle:(NSString *)Title;

@end

@interface VTDBase-BaseWithOptionsButtonViewController : VTDBase-VolutaBaseViewController <
...
@property (assign) id<VTDBase-BaseOptionsDelegate> OptionsDelegate;
