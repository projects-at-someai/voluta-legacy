...
@class VTDBase-VolutaBaseViewController;

@protocol VTDBase-BaseViewControllerBackgroundDelegate <NSObject>
@required
...
@protocol VTDBase-BaseViewControllerDelegate <NSObject>

@optional
- (void)VCComplete:(VTDBase-VolutaBaseViewController *)VC destinationViewController:(NSString *)VCName;

@end

@protocol VTDBase-BasePasswordDelegate <NSObject>
...
@interface VTDBase-VolutaBaseViewController : UIViewController <PWPopupDelegate, IdleSlideshowDelegate>
{
...
@property (assign) id<VTDBase-BaseViewControllerBackgroundDelegate> BaseBackgroundDelegate;
@property (assign) id<VTDBase-BaseViewControllerDelegate> BaseDelegate;
@property (assign) id<VTDBase-BasePasswordDelegate> PasswordDelegate;
