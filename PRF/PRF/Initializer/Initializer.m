...
- (void)InitializeDefaults {
    ...
    if ([defaults objectForKey:NUM_FORMS_REVIEW_KEY] == nil) {

        [defaults setInteger:40 forKey:NUM_FORMS_REVIEW_KEY];
    }
    ...
    [self CheckforJewelryPLists];
}

- (void)CheckLegacyForms {

    int numlegacyforms = 0;
    
    NSData *numFormsData = [KeychainWrapper searchKeychainCopyMatchingIdentifier:@"NPFS"];
    ...
    if (numFormsData != nil) {
        ...
        [KeychainWrapper deleteItemFromKeychainWithIdentifier:@"NPFS"];
    }
    
    numFormsData = [KeychainWrapper searchKeychainCopyMatchingIdentifier:@"NPFS-UK"];
    ...
    if (numFormsData != nil) {
        ...
        [KeychainWrapper deleteItemFromKeychainWithIdentifier:@"NPFS-UK"];
        
    }
    
    numFormsData = [KeychainWrapper searchKeychainCopyMatchingIdentifier:@"NPFS-AUS"];
    ...
    if (numFormsData != nil) {
        ...
        [KeychainWrapper deleteItemFromKeychainWithIdentifier:@"NPFS-AUS"];
    }
    
    if (numlegacyforms > 0) {
        
        InAppPurchaseManager *IAPManager = [[SharedData SharedInstance] GetIAPManager];
        [IAPManager IncForms:numlegacyforms];
    }
}

- (void)CheckforJewelryPLists
{
    //Check if plist exists in documents directory
    NSArray *documentPaths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
    NSString *documentsDir = [documentPaths objectAtIndex:0];
    NSString *pListPath = [documentsDir stringByAppendingPathComponent:@"JewelryGauges.plist"];
    ...
    {
        NSLog(@"plist not found, copying default to documents directory");
        // Copy the database from the package to the users filesystem
        
        [self CopyDefaultPListFromBundle:@"JewelryGauges"
                              fromBundle:@"PRFBundle"
                        withDestFileName:[_DocumentsDir stringByAppendingPathComponent:@"JewelryGauges.plist"]];
        
    }
    
    pListPath = [documentsDir stringByAppendingPathComponent:@"JewelryGemColors.plist"];
    ...
    if ([filemgr fileExistsAtPath: pListPath ] == NO)
    {
        ...
        [self CopyDefaultPListFromBundle:@"JewelryGemColors"
                              fromBundle:@"PRFBundle"
                        withDestFileName:[_DocumentsDir stringByAppendingPathComponent:@"JewelryGemColors.plist"]];
        
    }
    
    pListPath = [documentsDir stringByAppendingPathComponent:@"JewelryGemSettings.plist"];
    ...
    if ([filemgr fileExistsAtPath: pListPath ] == NO)
    {
        ...
        [self CopyDefaultPListFromBundle:@"JewelryGemSettings"
                              fromBundle:@"PRFBundle"
                        withDestFileName:[_DocumentsDir stringByAppendingPathComponent:@"JewelryGemSettings.plist"]];
    }
    
    pListPath = [documentsDir stringByAppendingPathComponent:@"JewelryGemBallSizes.plist"];
    ...
    if ([filemgr fileExistsAtPath: pListPath ] == NO)
    {
        ...
        [self CopyDefaultPListFromBundle:@"JewelryGemBallSizes"
                              fromBundle:@"PRFBundle"
                        withDestFileName:[_DocumentsDir stringByAppendingPathComponent:@"JewelryGemBallSizes.plist"]];
        
    }
    
    pListPath = [documentsDir stringByAppendingPathComponent:@"JewelryManufacturers.plist"];
    ...
    if ([filemgr fileExistsAtPath: pListPath ] == NO)
    {
        ...
        [self CopyDefaultPListFromBundle:@"JewelryManufacturers"
                              fromBundle:@"PRFBundle"
                        withDestFileName:[_DocumentsDir stringByAppendingPathComponent:@"JewelryManufacturers.plist"]];
    }
    
    pListPath = [documentsDir stringByAppendingPathComponent:@"JewelryMaterials.plist"];
    ...
    if ([filemgr fileExistsAtPath: pListPath ] == NO)
    {
        ...
        [self CopyDefaultPListFromBundle:@"JewelryMaterials"
                              fromBundle:@"PRFBundle"
                        withDestFileName:[_DocumentsDir stringByAppendingPathComponent:@"JewelryMaterials.plist"]];
        
    }
    
    pListPath = [documentsDir stringByAppendingPathComponent:@"JewelrySizes.plist"];
    ...
    if ([filemgr fileExistsAtPath: pListPath ] == NO)
    {
        ...
        [self CopyDefaultPListFromBundle:@"JewelrySizes"
                              fromBundle:@"PRFBundle"
                        withDestFileName:[_DocumentsDir stringByAppendingPathComponent:@"JewelrySizes.plist"]];
        
    }
    
    pListPath = [documentsDir stringByAppendingPathComponent:@"JewelryTypes.plist"];
    ...
    if ([filemgr fileExistsAtPath: pListPath ] == NO)
    {
        ...
        [self CopyDefaultPListFromBundle:@"JewelryTypes"
                              fromBundle:@"PRFBundle"
                        withDestFileName:[_DocumentsDir stringByAppendingPathComponent:@"JewelryTypes.plist"]];
